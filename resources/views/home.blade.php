    ...
    <nav class="max-w-7xl mx-auto grid grid-cols-3 py-8 px-8 xl:py-20">
        <div class="flex w-full items-center">
            <a
                ...
                target="_blank"
                class="text-gray-900 transition hover:text-primary-500"
            >
        ...
        <div class="flex w-full items-center justify-center">
            <a href="{{ route('home') }}" class="text-gray-900 transition hover:text-primary-500">
        ...
        <div class="flex w-full items-center justify-end">
            <a href="/docs/admin" class="font-medium text-gray-900 transition hover:text-primary-500">
