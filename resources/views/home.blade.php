<x-layout>
    <nav class="max-w-7xl mx-auto grid grid-cols-3 py-8 px-8 xl:py-20">
        ...
        <div class="flex w-full items-center justify-center">
            <a href="{{ route('home') }}" class="text-gray-900 transition hover:text-primary-600">
                <svg fill="currentColor" viewBox="0 0 160 32" class="h-auto w-24 sm:w-36">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <div class="text-lg text-gray-200 space-y-2">
                                    ...
                                    <p>
                                        Generate <a href="/docs/forms/components#date-time-picker" class="font-medium transition hover:text-yellow-100">date pickers</a>, searchable <a href="/docs/forms/components#select" class="font-medium transition hover:text-yellow-100">select menus</a>, <a href="/docs/forms/components#rich-editor" class="font-medium transition hover:text-yellow-100">rich text editors</a> and <a href="/docs/forms/components#file-upload" class="font-medium transition hover:text-yellow-100">file upload</a> fields with just one line of PHP.
                                    </p>
                                </div>
                            </div>

                            <div>
                                <a href="https://github.com/laravel-filament/filament/discussions/495" class="bg-yellow-100 space-x-1 rounded-full py-2 px-4 text-sm text-yellow-800">
                                    <span>
