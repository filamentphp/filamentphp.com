...
>
    ...
    >
        ...
        <ul class="space-y-10 pt-10">
            <li class="flex flex-col items-center gap-8 rounded-xl bg-merino/50 px-10 py-4 text-evening md:flex-row">
                <div class="flex shrink-0 items-center gap-3">
                    <div
                        class="w-28 h-28 bg-center bg-no-repeat bg-cover rounded-full ring-1 ring-white"
                        style="background-image: url('{{ Vite::asset('resources/images/consulting/michaela.webp') }}')"
                    >
                        <span class="sr-only">
                            Michaela Shiloh
                        </span>
                ...
                <div class="flex-1">
                    ...
                    <div class="px-2 pb-2 pt-5 font-medium">
                        Kirschbaum quickly proved what a well-managed web development experience looks like
                        and feels like. Their team has been excellent with communication, time management,
                        and deliverables. They have gone above and beyond to meet our creative and technical needs.
                    </div>
