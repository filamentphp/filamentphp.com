                ...
                >
                    ...
                    >
                        ...
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            class="transition duration-400 [grid-area:1/-1] group-hover/call:rotate-45 group-hover/call:opacity-0"
                        >
                            <path
                        ...
                        <svg
                            ...
                            height="20"
                            viewBox="0 0 24 24"
                            class="-rotate-45 opacity-0 transition duration-400 [grid-area:1/-1] group-hover/call:rotate-0 group-hover/call:opacity-100"
                        >
                            <path
                                fill="none"
                                stroke="currentColor"
