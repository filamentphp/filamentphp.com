...
>
    ...
    <div class="relative pt-5 min-[630px]:grid">
        ...
        >
            ...
            >
                ...
                <a
                    href="https://tailwindcss.com"
                    target="_blank"
                    class="group/tall-link flex items-center gap-3 transition duration-300"
                >
                    {{-- Logo --}}
                ...
                >
                    ...
                    <div class="flex items-end gap-px">
                        <span class="text-2xl font-bold">A</span>
                        <span class="text-lg transition duration-500">
                            lpine.js
                        </span>
                    </div>
                </a>
        ...
        {{-- Stats --}}
        <div
            class="relative flex w-full flex-wrap items-center justify-center gap-x-10 gap-y-5 self-start justify-self-start pt-14 min-[600px]:pt-60 min-[700px]:pt-0 md:top-20 md:w-auto md:flex-col md:[grid-area:1/-1]"
        >
            {{-- Downloads --}}
            <div
