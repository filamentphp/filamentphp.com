    ...
    <div class="flex gap-5 items-start justify-between">
        <div>
            ...
            <div class="text-4xl font-black italic relative">
                ...
                <span class="absolute -z-10 -left-2 top-1
                    text-[#FFEFE1]
                    ">
                    Accelerated
                </span>
                <div class="space-y-1 absolute top-1/2 -translate-y-1/2 -left-12">
                    <div class="w-7 h-0.5 rounded-full bg-gradient-to-r from-transparent to-[#FFC089] translate-x-5"></div>
                    <div class="w-10 h-0.5 rounded-full bg-gradient-to-r from-transparent to-[#FFC089]"></div>
                    <div class="w-12 h-0.5 rounded-full bg-gradient-to-r from-transparent to-[#FFC089] -translate-x-4"></div>
                </div>
            </div>
            ...
            <div class="pt-3">
                ...
                <div class="pt-5 relative">
                    {{-- Description --}}
                    <div class="text-2xl font-medium leading-normal opacity-90">
                    ...
                    <div class="absolute top-1 -right-5">
                        <svg width="31" height="31" class="scale-[.65]" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m17.664 29.354 3.06-8.755 8.679-3.27a2.183 2.183 0 0 0-.05-4.092l-8.754-3.06-3.27-8.679a2.183 2.183 0 0 0-4.092.05l-3.06 8.754-8.68 3.27a2.183 2.183 0 0 0 .05 4.092l8.755 3.06 3.27 8.679a2.183 2.183 0 0 0 4.092-.05Zm-5.325-9.391a2.142 2.142 0 0 0-1.325-1.294l-8.741-3.06 8.665-3.27a2.143 2.143 0 0 0 1.294-1.325l3.06-8.741 3.27 8.665a2.142 2.142 0 0 0 1.325 1.294l8.74 3.06-8.664 3.27a2.141 2.141 0 0 0-1.294 1.325l-3.06 8.741-3.27-8.665Z" fill="#0F033A"/></svg>
                    </div>
                </div>
            </div>

            {{-- Links --}}
            <div class="pt-10 flex gap-5 items-center text-white">
            ...
            {{-- Decoration Arrow --}}
            <div class="pt-2 -translate-x-32">
                <img src="{{ Vite::asset('resources/svg/home/decoration-up-arrow-red.svg') }}" alt="" class="w-32" />
            </div>
        </div>

        {{-- Rocket --}}
        <div class="relative">
            <img src="{{ Vite::asset('resources/images/home/rocket.webp') }}" alt="" class="w-80" />

            {{-- Decoration Circles --}}
            <div class="absolute bottom-0 -right-5 w-4 h-4 rounded-full bg-[#FFCEA0]"></div>
            <div class="absolute -bottom-20 right-20 w-7 h-7 rounded-full bg-[#FFE69A]"></div>
        </div>
    </div>
</div>