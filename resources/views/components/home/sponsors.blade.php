        ...
        >
            ...
            >
                <svg
                    ...
                    viewBox="0 0 460 89"
                >
                    <path d="M44.473 89C69.0348 89 88.946 69.0767 88.946 44.5C88.946 19.9233 69.0348 0 44.473 0C19.9112 0 0 19.9233 0 44.5C0 69.0767 19.9112 89 44.473 89Z" fill="url(#paint0_linear_425_2)" />
                    <path
                        ...
                        fill="#E7E8E9"
                    />
                    <path d="M66.306 39.76C67.742 38.046 67.637 35.63 66.096 34.476C65.115 33.742 64.168 33.006 63.188 32.306C59.368 37.066 49.138 49.279 40.099 55.543C40.799 56.488 40.449 55.893 41.149 56.838C42.306 58.378 44.724 58.448 46.44 57.013C53.202 51.274 60.56 46.549 66.306 39.76Z" fill="white" />
                    <path d="M33.856 41.852L37.199 45.192L32.22 50.166L28.876 46.826L33.856 41.852Z" fill="#E7E8E9" />
                    <path
                    ...
                    />
                    <defs>
                        <linearGradient id="paint0_linear_425_2" x1="16845" y1="14656.6" x2="-8.63597" y2="254.053" gradientUnits="userSpaceOnUse">
            ...
            >
                ...
                >
                    <path d="M116.65,18.58v1.84l-15.67,28.46h15.27v2.84H96.99v-1.84l15.82-28.51H97.74v-2.79H116.65z"/>
                    <path d="M143.86,18.58v2.79h-14.48v12.19h11.54v2.74h-11.54v12.64h14.58v2.79h-17.71V18.58H143.86z"/>
                    <path d="M171.02,18.58v2.79h-14.48v12.19h11.54v2.74h-11.54v12.64h14.58v2.79H153.4V18.58H171.02z"/>
                    <path d="M187.98,35.55l-4.23,5.92v10.25h-3.18V18.58h3.18v18.71l12.98-18.71h3.63l-10.35,14.43c2.69,4.73,10.5,18.71,10.5,18.71
		h-3.53C196.98,51.71,190.27,39.67,187.98,35.55z"/>
                    <path d="M60.59,36.39h-10.4l7.2-27.57H16.05L18.36,0h51.74L60.59,36.39z"/>
                    <path d="M51.74,70.28H0l9.5-36.39h10.4l-7.2,27.57h41.34L51.74,70.28z"/>
                    <path d="M64.85,53.34H24.37l7.2-27.57H2.95l2.3-8.82h40.47l-7.2,27.58h28.63L64.85,53.34z"/>
                </svg>
            </a>
