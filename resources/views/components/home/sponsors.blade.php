...
>
    ...
    >
        ...
        >
            <a class="grid place-items-center transition duration-300 will-change-transform hover:scale-110 motion-reduce:transition-none motion-reduce:hover:transform-none" href="https://ploi.io" target="_blank" title="Ploi">
                <svg class="w-auto h-9 mt-3 fill-current" viewBox="0 0 253 93.3">
            ...
            <a class="grid place-items-center transition duration-300 will-change-transform hover:scale-110 motion-reduce:transition-none motion-reduce:hover:transform-none" href="https://codecourse.com" target="_blank" title="Codecourse">
