...
>
    <div class="">
        ...
        <div
            class="rounded-[2rem] bg-gradient-to-tr from-[#24263A] to-[#2E2F47] p-14 text-white"
        >
            {{-- Header --}}
            ...
            <div class="grid grid-cols-2 gap-x-12 gap-y-10 px-16 pb-7 pt-16">
                <a
                    href="#"
                ...
                >
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="max-w-xs text-sm text-rum">
                            Easily build stunning forms with over 25 components
                            out of the box.
                        </div>
                    </div>
                </a>
                ...
                >
                    ...
                    <div class="space-y-0.5">
                        <div class="flex items-center gap-2">
                            <div class="text-base font-medium">Info Lists</div>
                            <div
                                class="rounded-full bg-[#C8A3F7] px-3 py-0.5 text-xs font-medium text-black"
                            >
                                New
                        ...
                        <div class="max-w-xs text-sm text-rum">
                            Summarize your data into beautiful lists and report
                            cards.
                        </div>
                    </div>
                </a>
        ...
        <div class="flex justify-start">
            ...
            <img
                ...
                alt=""
                class="w-12 relative -left-9 -top-2"
            />
        </div>
    </div>
</div>
