...
>
    ...
    >
        <div class="text-black">
            ...
            >
                {{-- F --}}
                <path
                    class="transition duration-300 will-change-transform group-hover/filament:-translate-x-[1.2rem]"
                ...
                {{-- I --}}
                <path
                    class="transition duration-300 will-change-transform group-hover/filament:scale-90"
                ...
                {{-- L --}}
                <path
                    class="transition duration-300 will-change-transform group-hover/filament:translate-x-3"
            ...
            {{-- Bulb --}}
            <div
                class="absolute -left-2 -top-3.5 -z-10 opacity-0 transition duration-300 will-change-transform group-hover/filament:opacity-100 min-[400px]:-left-1 md:-left-px md:-top-2.5"
            >
                <svg
                    width="37"
                    height="52"
    ...
    <div class="flex items-center justify-end gap-8 font-semibold sm:gap-14">
        <div class="group/packages relative">
            <div
                class="peer hidden text-evening opacity-80 transition delay-75 duration-300 group-hover/packages:opacity-100 lg:block"
            >
                <div class="fadein flex items-center gap-2">
                    <div class="">Packages</div>
                    <div
                        class="transition duration-200 group-hover/packages:rotate-180"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                ...
                >
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid gap-7">
                            <a
                                href="#"
                                class="group/package-link flex items-center gap-5 transition duration-300 will-change-transform hover:translate-x-0.5"
                            >
                                <div
        ...
        <div class="group/github relative">
            ...
            <a
                ...
                target="_blank"
                class="peer text-evening opacity-80 transition delay-75 duration-300 group-hover/github:opacity-100"
            >
                <div class="fadein">
                    <svg
                        fill="currentColor"
            ...
            {{-- Star Count --}}
            <div
                class="invisible absolute right-1/2 top-7 -translate-y-2 translate-x-1/3 p-3 opacity-0 transition delay-75 duration-300 hover:visible hover:translate-y-0 hover:opacity-100 peer-hover:visible peer-hover:translate-y-0 peer-hover:opacity-100 min-[1400px]:translate-x-1/2"
            >
                <div
                ...
                >
                    ...
                    <div class="text-sm text-evening">7.1k Stars</div>
                </div>
            </div>
        </div>
    </div>
