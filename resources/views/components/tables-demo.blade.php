...
<div x-data="{ theme: $persist('dark') }" {{ $attributes->class(['relative -mx-4 sm:mx-auto max-w-6xl mx-auto transition hover:scale-[1.02]']) }}>
    ...
    >
        ...
        >
            ...
            >
                <span
                    ...
                    class="pointer-events-none relative inline-block h-6 w-6 px-2 rounded-lg bg-white shadow translate ring-0 ease-in-out transition duration-200"
                >
                    <span
        ...
        <a href="https://demo.filamentphp.com/blog/posts" target="_blank" class="flex w-full rounded-b-2xl overflow-hidden">
            <div class="relative">
                <img
