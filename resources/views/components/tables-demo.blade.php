...
<div x-data="{ theme: $persist('dark') }" {{ $attributes->class(['relative -mx-4 sm:mx-auto max-w-6xl mx-auto transition hover:scale-[1.02]']) }}>
    ...
    >
        ...
        >
            ...
            >
                <span
                    ...
                    class="relative inline-block w-6 h-6 px-2 transition duration-200 ease-in-out bg-white rounded-lg shadow pointer-events-none translate ring-0"
                >
                    <span
        ...
        <a href="https://demo.filamentphp.com/blog/posts" target="_blank" class="flex w-full overflow-hidden rounded-b-2xl">
            <div class="relative">
                <img
                    src="{{ asset('images/tables/demo/light.jpg') }}"
                    alt="Screenshot of the table builder demo"
                />

                <img
                    src="{{ asset('images/tables/demo/dark.jpg') }}"
                    aria-hidden="true"
                    alt="Screenshot of the table builder demo"
                    x-bind:class="{
