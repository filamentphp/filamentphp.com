<div
    class="mx-0.5 flex h-[36px] min-w-[36px] cursor-pointer items-center justify-center rounded-xl text-sm text-neutral-700 transition-all duration-300 select-none active:scale-90"
    :class="{
