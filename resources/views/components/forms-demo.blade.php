...
>
    ...
    >
        ...
        <a
            href="https://demo.filamentphp.com/shop/products/{{ rand(1, 50) }}/edit"
            target="_blank"
            class="flex max-h-[200px] w-full overflow-hidden rounded-b-2xl sm:max-h-[300px] md:max-h-[500px] lg:max-h-[600px]"
        >
