<x-layouts.app>
    <x-header>
        ...
        <x-slot name="subheading">
            A curated collection of articles written by the Filament team and
            our community.
        </x-slot>

        <x-slot name="doodles">
            <div class="absolute inset-y-0 left-10 hidden items-center lg:flex">
                <img
                    src="{{ asset('images/glasses.svg') }}"
                    alt="Glasses"
                    class="h-[7rem] scale-x-[-1] transform"
                />
            </div>
            ...
            <div class="flex-grow space-y-8">
                <div class="space-y-4">
                    ...
                    <p class="text-xl text-white">
                        Visit the article dashboard to publish your own articles
                        to our website!
                    </p>
                </div>
