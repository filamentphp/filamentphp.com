        ...
        <div class="mx-auto max-w-4xl">
            <div class="mt-6">
                <div class="space-y-4">
                    <a
                        href="{{ route('blog') }}"
                        class="block font-heading text-xs font-bold uppercase tracking-wider text-primary-600"
                    >
                        Blog
                    </a>

                    <p
                        class="font-heading text-3xl font-bold tracking-tight text-gray-900"
                    >
                        {{ $article->title }}
                    </p>

                    <dl
                        class="flex flex-wrap items-start gap-x-6 gap-y-2 font-medium text-gray-500"
                    >
                ...
                <div class="prose mt-16 max-w-none">
                    @php
                        config()->set('markdown', \Illuminate\Support\Arr::except(include config_path('markdown.php'), ['table_of_contents']));
                        ...
                        app()->singleton('markdown.environment', function (\Illuminate\Contracts\Container\Container $app): \League\CommonMark\Environment\Environment {
                            ...
                            collect($config['extensions'])
                                ->reject(fn (string $extension): bool => in_array($extension, [\League\CommonMark\Extension\TableOfContents\TableOfContentsExtension::class]))
                ...
                <div class="mt-8 flex w-full items-center gap-3 text-sm">
                    <a
                    ...
                    >
                        <svg
                            class="h-4 w-4 text-blue-400 hover:text-blue-500"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            aria-hidden="true"
                        >
                    ...
                    >
                        <svg
                            class="h-4 w-4 text-orange-400 hover:text-orange-500"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            stroke-width="2"
                ...
                <div class="mt-8 space-y-2">
                    ...
                    <div
                        class="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-3"
                    >
