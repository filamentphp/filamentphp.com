<x-layouts.app previewify="757" :previewify-data="[
    ...
    <section>
        <div class="bg-primary-300 -mt-[8rem] md:-mt-[20rem] pt-[8rem] md:pt-[16rem] lg:-mt-[24rem]">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-8 mx-auto max-w-5xl">
                        <p class="text-gray-800/80 font-medium text-xl">
                            Our TALL stack admin panel is a collaboration between all our other packages. Each package already provides you with a comprehensive set of features, now imagine all of those combined into one product!
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-16 max-w-5xl mx-auto grid grid-cols-2 px-8 gap-8">
            <div class="col-span-1 space-y-4 rounded-2xl bg-primary-300/30 border-4 border-primary-300 p-6">
                <div>
                    <x-heroicon-s-home class="w-8 h-8" />
                </div>
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-gray-800/80 text-sm">
            ...
            <div class="col-span-1 rounded-2xl bg-primary-300/30 border-4 border-primary-300 p-6">
                <h2 class="font-heading text-black-900/80 text-xl">
                    Datatables on steroids
                </h2>

                <p class="mt-4 text-gray-800/80">
                    We've harnessed the power of Eloquent to build a table component with first class features.
                </p>

                <p class="mt-4 text-gray-800/80">
                    Advanced filtering, pagination, row selection with bulk-actions, drag and drop reordering, relationship data presentation and aggregation.
                </p>
            </div>
            ...
            <div class="col-span-1 rounded-2xl bg-primary-300/30 border-4 border-primary-300 p-6">
                ...
                <p class="mt-4 text-gray-800/80">
                    Our wonderful community has built a wide range of packages that were crafted out of their own need for additional Filament functionality in their projects.
                </p>
            </div>
        </div>
