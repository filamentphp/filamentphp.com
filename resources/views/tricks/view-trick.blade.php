                ...
                <div class="space-y-4">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            ...
                            <dd>
                                {{ $trick->created_at->toFormattedDateString() }}
                            </dd>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <dd>
                                {{ collect($trick->categories)->map(fn (string $category): string => \App\Enums\TrickCategory::tryFrom($category)?->getLabel())->implode(', ') }}
                            </dd>
                        </div>
