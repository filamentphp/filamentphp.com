...
Once you've set up and compiled a custom theme, if the Tailwind class you need is still not compiled, check the `content` array of the theme's `tailwind-site.config.js` file, to ensure that your file is included.
